...
class ParallelVocabEmbedding(nn.Module):
    ...
    def reset_parameters(self) -> None:
        """
        使用正态分布 N(init_mean, init_std^2) 初始化本地 embedding 表 Tr。
        随机种子 = init_base_seed + rank。
        """
    ...
    def forward(self, input_ids: torch.Tensor) -> torch.Tensor:
        ...
        返回: Er, [batch_size, seq_len, emb_size]
              - device 与 input_ids 相同
              - dtype 与 self.weight 相同
        """
